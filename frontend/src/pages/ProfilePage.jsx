...
import { Container, Card, LoadingSpinner, Button, Input, ToastContainer } from '../components/ui';
...
const ProfilePage = () => {
  ...
  const handleFileChange = async (event) => {
    ...
    try {
      ...
      showToast(t('user.upload_failed', 'Failed to upload image'), 'error');
    } finally {
      setUploading(false);
    }
  };
                  ...
                  {uploading ? (
                    ...
                    <>
                      {(editForm.avatar_url || user.avatar_url) ? (
                        <img src={editForm.avatar_url || user.avatar_url} alt={user.name} className="avatar-img" />
                      ) : (
